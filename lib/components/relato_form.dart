...
class _RelatoFormState extends State<RelatoForm> {
  ...
  Future<void> _enviarRelato(String token) async {
    setState(() {
      isLoading = true;
    ...
    try {
      final url = Uri.parse('https://aricrimes-api.gabiruka.duckdns.org/relato/');
  ...
  Widget build(BuildContext context) {
    final token = Provider.of<MyAuthProvider>(context, listen: false).accessToken;
          ...
          child: Column(
            children: [
              TextFormField(
                ...
                validator: (v) => v == null || v.isEmpty ? 'Informe o objeto' : null,
